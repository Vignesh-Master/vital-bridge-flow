      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
        <div className="flex items-center justify-center h-16 bg-red-600">
          <div className="flex items-center">
            ...
            <span className="text-white text-xl font-bold">OrganLink Admin</span>
          </div>
        </div>
        ...
        <nav className="mt-8">
          <div className="px-4 space-y-2">
            {navigation.map((item) => (
              ...
              >
                <span className={`mr-3 ${isCurrentPage(item.href) ? 'text-red-600' : 'text-gray-400 group-hover:text-gray-500'}`}>
                  {item.icon}
                </span>
                {item.name}
              </Link>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          ...
          <button
            ...
            className="mt-3 w-full bg-red-600 text-white text-sm py-2 px-4 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center"
          >
