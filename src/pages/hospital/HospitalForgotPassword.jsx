...
const HospitalForgotPassword = () => {
  ...
  const handleVerifySubmit = (e) => {
    ...
    console.log('Hospital verify attempt:', { userId: formData.userId, hospitalId: formData.hospitalId });
  ...
  const handleResetSubmit = (e) => {
    ...
    console.log('Hospital password reset attempt:', formData);
  };
      ...
      <header className="forgot-header">
        <div className="container">
          <div className="header-content">
            ...
            <Link to="/hospital/login" className="back-link">
          ...
          <div className="forgot-content">
            <div className="form-container">
              {step === 1 ? (
                  ...
                  <div className="form-header">
                    <div className="icon-container">
                      <svg width="60" height="60" viewBox="0 0 24 24" fill="none">
                        <path d="M3 9L12 2L21 9V20A2 2 0 0 1 19 22H5A2 2 0 0 1 3 20V9Z" stroke="currentColor" strokeWidth="2" fill="none"/>
                        <polyline points="9,22 9,12 15,12 15,22" stroke="currentColor" strokeWidth="2"/>
                      </svg>
                    </div>
                    <h1 className="heading-2 mb-1">Reset Hospital Password</h1>
                    <p className="text-large">Enter your hospital credentials to verify your identity</p>
                  </div>
                  ...
                  <form onSubmit={handleVerifySubmit} className="form">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        placeholder="Enter your unique user ID (e.g., ch-001)"
                        required
                      />
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="form-input"
                        placeholder="Enter your hospital ID (e.g., apollo-chennai)"
                        required
                      />
                    </div>
                ...
                <div className="form-section fade-in">
                  <div className="form-header">
                    ...
                    <p className="text-large">Hospital credentials verified! Please create a new secure password</p>
                  </div>
              ...
              <div className="help-text">
                <p>Need help? Contact your hospital IT administrator or</p>
