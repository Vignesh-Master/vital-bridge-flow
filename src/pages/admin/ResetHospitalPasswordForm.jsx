...
const ResetHospitalPasswordForm = ({
  onSubmit,
  onCancel,
  loading = false,
  error = ''
  ...
  return (
    <form className="reset-password-form card" onSubmit={handleSubmit}>
      <div className="form-section">
        <h3 className="heading-3 mb-2">Reset Hospital Password</h3>
        <div className="form-group">
          ...
          <input
            ...
            placeholder="Enter new password for hospital login"
            minLength={6}
            maxLength={255}
            required
          />
...
export default ResetHospitalPasswordForm;
