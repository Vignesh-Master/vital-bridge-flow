...
const ForgotPassword = () => {
  ...
  const handleVerifySubmit = (e) => {
    ...
    console.log('Verify attempt:', { staffId: formData.staffId, hospitalId: formData.hospitalId });
              ...
              {step === 1 ? (
                ...
                <div className="form-section fade-in">
                  <div className="form-header">
                    ...
                    <h1 className="heading-2 mb-1">Reset Password</h1>
                    <p className="text-large">Enter your staff credentials to verify your identity</p>
                  </div>
                ...
                <div className="form-section fade-in">
                  <div className="form-header">
                    ...
                    <p className="text-large">Credentials verified! Please create a new secure password</p>
                  </div>
